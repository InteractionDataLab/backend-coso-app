...
ActiveRecord::Schema[7.0].define(version: 2022_12_14_133107) do
  ...
  create_table "programs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name", "year"], name: "index_programs_on_name_and_year", unique: true
  end
  ...
  create_table "survey_fields", force: :cascade do |t|
    ...
    t.jsonb "dependency", default: {"value"=>"", "survey_field_id"=>""}, null: false
  ...
  create_table "surveys", force: :cascade do |t|
    ...
    t.bigint "team_id", default: [], null: false, array: true
    t.string "name", null: false
